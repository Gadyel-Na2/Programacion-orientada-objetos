...
public class Proyecto {
    ...
    private static HashMap<String, List<String>> equipos = new HashMap<>();
    ...
    private static void iniciarSesion(Scanner scanner) {
        ...
        if (usuarios.get(usuario).equals(contrasena)) {
            ...
            if (rol.equals("Administrador")) {
                ...
                mostrarMenuGerenteProyecto(scanner, usuario); // Pasar usuario
            } else {
                mostrarMenuDesarrollador(scanner, usuario); // Pasar usuario
            }
        } else {
    ...
    private static void mostrarMenuAdministrador(Scanner scanner, String usuario) {
        ...
        while (!salir) {
            ...
            System.out.println("8. Formar equipo");
    ...
    private static void mostrarMenuGerenteProyecto(Scanner scanner, String usuario) {
        boolean salir = false;
        while (!salir) {
            ...
            System.out.println("3. Ver notificaciones");
            System.out.println("4. Formar equipo");
            System.out.println("5. Actualizar perfil"); // Nueva opción
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        actualizarPerfil(scanner, usuario); // Llamar a actualizarPerfil
                        break;
                    case 6:
                        salir = true;
                        break;
    ...
    private static void mostrarMenuDesarrollador(Scanner scanner, String usuario) {
        boolean salir = false;
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        actualizarPerfil(scanner, usuario); // Usar método genérico
                        break;
                    case 4:
